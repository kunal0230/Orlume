...
flowchart TD
    ...
    L --> M{"GPU Renderer\nAvailable?"}
    M -->|"WebGPU"| N1["🖥️ WebGPU Renderer\n(WGSL Shader)"]
    M -->|"WebGL2"| N2["🖥️ WebGL2 Deferred Renderer\n(GLSL Shader)"]
...
flowchart LR
    ...
    TRY_GL -->|"✅ Success"| WEBGL2["🖥️ WebGL2\n(GLSL ES 3.0)\n95% of Users"]
...
flowchart TD
    subgraph Background["🔄 Background Loading (App Open)"]
        ...
        CACHE -->|No| DOWNLOAD["⬇️ Download ~50MB\nWith Progress Callbacks"]
