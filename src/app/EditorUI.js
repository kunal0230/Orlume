...
export class EditorUI {
    constructor(state, gpu, masks) {
        ...
        this.crashReporterModule = new CrashReporterModule(this);
        this.crashReporterModule.init();
